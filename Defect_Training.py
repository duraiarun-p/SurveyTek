...
def prepare_data(Datadir,fname_defect_dataset_14400,f_name_defect_class_labels,fname_defect_dataset,flag):
...
flag=True
dataset, class_labels, lda_input,classes = prepare_data(Datadir,fname_defect_dataset_14400,f_name_defect_class_labels,fname_defect_dataset,flag)
